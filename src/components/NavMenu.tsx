    ...
    <>
      ...
      >
            ...
            >
              ...
              <ul className="space-y-2">
                {[
                  {
                    name: "LinkedIn",
                    link: "https://www.linkedin.com/in/o%C4%9Fuzhan-%C3%A7art-b73405199/",
                  },
                  {
                    name: "Instagram",
                    link: "https://instagram.com/oguzhan_cart",
                  },
                  { name: "Github", link: "https://github.com/oguzhan18" },
                ].map((item, index) => (
                  <motion.li
                    key={item.name}
                    initial={{ x: 20, opacity: 0 }}
        ...
        >
          ...
          <a href="mailto:oguzhancart@gmail.com" className="text-lg hover:underline">
            oguzhancart@gmail.com
          </a>
        </motion.div>
      </motion.div>

      <motion.div
        className="fixed left-6 top-6 z-[101] text-4xl font-bold"
        initial={{ opacity: 0 }}
