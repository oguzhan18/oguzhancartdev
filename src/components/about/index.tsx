  ...
  return (
    ...
    >
      ...
      >
        ...
        >
        I believe in a user-centered design approach and ensure that every project I work on is designed to meet the specific needs of its users. 
        I create my projects by finding new ideas or improving existing ones. Creating libraries and tools that developers use is one of our top priorities.
        </motion.h1>
        ...
        >
          ...
          >
            <motion.p variants={fadeInUpVariants} custom={4}>
              I'm a 21 year-old passionate fullstack web developer dedicated to
            ...
            <motion.p variants={fadeInUpVariants} custom={5}>
            I have worked on many large-scale projects. I have developed many cross-platform projects. 
            I have created CSS libraries, framework libraries, and CRM - CMS - ERP projects, and 
            I have completed numerous customer-focused projects.
            </motion.p>
          </div>
          {isMobile && (
            <motion.button
